  ...
  Widget _buildFeaturedSection() {
    return SliverToBoxAdapter(
      child: Obx(() {
        ...
        return InkWell(
          onTap: () => Get.toNamed(Routes.NEWS_DETAIL, arguments: featuredArticle),
          child: Container(
            height: 500,
                      ...
                      Row(
                        children: [
                          ...
                          if (featuredArticle.publishedAt != null)
                            Text(
                              timeago.format(DateTime.parse(featuredArticle.publishedAt!)).toUpperCase(),
                              style: TextStyle(
                                color: Colors.white.withOpacity(0.8),
                                fontSize: 12,
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    if (article.publishedAt != null)
                      Text(
                        timeago.format(DateTime.parse(article.publishedAt!)).toUpperCase(),
                        style: const TextStyle(
                          fontSize: 11,
